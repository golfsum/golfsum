    ...
    <View style={[styles.chrome, { paddingTop: Math.max(0, topInset - 4) }]} pointerEvents="box-none">
        ...
        <View style={styles.headerTopRow}>
          ...
          <View style={styles.headerCenter}>
            ...
            <Text style={styles.subMeta} numberOfLines={1}>
              {cachedLabel} • {selectedTeeName || '--'}{routeLabel ? ` • ${routeLabel}` : ''} • {selectedTeeYardage ? `${selectedTeeYardage}y` : '--'}
            </Text>
            <Text style={styles.holeInfoLine} numberOfLines={1}>
              Hole {hole.hole} • Par {hole.par} • {selectedTeeYardage ? `${selectedTeeYardage}y` : '--'} • HCP {hole.handicap ?? '-'}
            </Text>
          </View>
      ...
      >
        <HoleSelectorBar
          ...
          selectedHole={(currentHoleIndex ?? 0) + 1}
          onSelect={onSelectHole}
          holesWithData={loggedHoles}
