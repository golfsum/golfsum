...
export default function FeaturesPage({ Icon }) {
  const features = [
    ...
    { icon: "compass", title: "GPS Live Round", items: ["Real-time yardages to front, center, and back of green", "Playing distance adjusted for wind, temperature, and elevation", "Satellite map view with shot tracking", "Automatic lie detection and smart club suggestions", "Course planning mode with tee shot markers and notes", "Ghost overlay comparing planned vs actual shots", "42,000+ courses with pre-download for offline play"] },
