...
- Ratings/slope may appear outside the main grid (for example near "USGA Rules", "RATINGS/SLOPE", or course notes). Parse those too and map by tee name.
...
- Do NOT copy handicap values into score. If score row is ambiguous or looks like handicap order (1-18), set score to null.
...
def parse_scorecard_with_gemini(image_bytes: bytes, mode: str = "course") -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(
            "gemini_http_error status=%s body_length=%s",
        ...
        return {
            ...
            "message": "Network error while calling Gemini",
        }
    ...
    try:
        ...
        return {
            ...
            "message": "Gemini response format was invalid",
        }
